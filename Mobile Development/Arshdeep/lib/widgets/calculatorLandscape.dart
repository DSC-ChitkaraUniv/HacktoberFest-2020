...
class CalculatorLandscape extends StatefulWidget {
  final String str;
  final String title;
  CalculatorLandscape({Key key, @required this.str, @required this.title}):super(key:key);
  @override
  _CalculatorLandscapeState createState() => _CalculatorLandscapeState(this.str);
}

class _CalculatorLandscapeState extends State<CalculatorLandscape> {
  String _str;
  _CalculatorLandscapeState(this._str);
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                Button('=',(){compute();},6,Colors.green,40,Colors.white),
              ],
            ),
          ),
        ],
